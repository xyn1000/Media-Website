...
create or replace function addsong(location text, songdescription text, title character varying, songlength integer, songgenre integer, artistid integer, artwork text) returns integer
    language sql
as
$$
WITH ins1 AS (
...
INSERT
INTO mediaserver.MediaItemMetaData
SELECT media_id, md_id
FROM ins1,
     ins2;
